...
const App = () => {
  ...
  const handleKeyDownOne = (event) => {
    if (event.key === "Tab") {
      toggleDropdownOne();
      setTimeout(() => {
        const dropdown = document.querySelector(":where([class*='dropdown'])");
  ...
  const convertMoney = (e) => {
    ...
    if (e.target.value.trim() !== "") {
      ...
      labelFrom.current.style.backgroundColor = "var(--color-background)";
      labelTo.current.style.transform = "translate(-5px, -15px)";
      labelTo.current.style.fontSize = "0.8rem";
      labelTo.current.style.backgroundColor = "var(--color-background)";
    }
    ...
    <>
        ...
        <section className="converter">
          ...
          <form className="form" method="get">
            <div className="form__field">
              <label className="form__field-label" htmlFor="currency-from" ref={labelFrom}>
              ...
              <div className="form__field-inputs">
                <input
                  ...
                  autoComplete="off"
                  inputMode="numeric"
                  aria-describedby="input-from-description"
                />
                <span className="visually-hidden" id="input-from-description">
                  Введите в поле ввода колличество сколько хотите перевести в {toCurrency}
                </span>
                <button
                  ...
                  aria-label="открыть меню чтобы выбрать валюту с которой выполнить перевод">
                  <svg
                    className={dropdownOne ? "rotate-svg" : ""}
                    aria-hidden="true"
                    ...
                    viewBox="0 0 16 16"
                    fill="currentcolor">
                    <path d="M8 12a.997.997 0 0 1-.707-.293l-5-5a.999.999 0 1 1 1.414-1.414L8 9.586l4.293-4.293a.999.999 0 1 1 1.414 1.414l-5 5A.997.997 0 0 1 8 12z"></path>
                  </svg>
                </button>
            ...
            <button
              ...
              type="button"
              aria-label="переключать валюты"
              onClick={switchCurrencies}
              onKeyDown={toggleDropdownOne}>
              <svg
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                ...
                viewBox="0 0 24 24"
                fill="currentcolor">
                <path d="M2 7h17.148l-2.773 2.219a1 1 0 1 0 1.25 1.562c5.494-4.396 5.156-4.156 5.156-4.156.305-.382.285-1.053-.156-1.406l-5-4a1 1 0 1 0-1.25 1.562L19.148 5H2C.677 5 .679 7 2 7zM22 17H4.852l2.773-2.219c1.031-.827-.216-2.389-1.25-1.562-.141.112-5.044 4.016-5.156 4.156l-.112.195c-.085.171-.106.461-.106.43 0 .249.146.599.375.781l5 4A1 1 0 0 0 7 23c.942 0 1.361-1.191.626-1.781L4.852 19H22a1 1 0 1 0 0-2z"></path>
              </svg>
            </button>
            <div className="form__field">
              <label className="form__field-label" htmlFor="currency-to" ref={labelTo}>
              ...
              <div className="form__field-inputs">
                <input
                  ...
                  onChange={convertMoney}
                  autoComplete="off"
                  aria-describedby="input-to-description"
                  inputMode="numeric"
                />
                <span className="visually-hidden" id="input-to-description">
                  Введите в поле ввода колличество сколько хотите перевести из {fromCurrency}
                </span>
                <button
                  className="form__field-button"
                  type="button"
                  ...
                  aria-label="открыть меню чтобы выбрать валюту в которую перевести валюту">
                  <svg
                    className={dropdownTwo ? "rotate-svg" : ""}
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
      ...
      <aside className="github">
        <a
          ...
          href="https://github.com/maxim-klenov/currency-converter"
          target="_blank"
          rel="noopener noreferrer"
          tabIndex="0"
          aria-label="открыть github страницу конвертера">
          <svg aria-hidden="true" xmlns="//www.w3.org/2000/svg" viewBox="0 0 250 250" fill="var(--color-background)">
            <path d="M0 0l115 115h15l12 27 108 108V0z" fill="var(--color-text)"></path>
            <path
              d="M128 109c-15-9-9-19-9-19 3-7 2-11 2-11-1-7 3-2 3-2 4 5 2 11 2 11-3 10 5 15 9 16"></path>
            <path
